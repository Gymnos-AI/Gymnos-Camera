class CameraRunnerFactory:
    """
    Returns an initialized implementation of a camera class, provided it is a supported type.
    """

    def get_camera_runner(self, camera_type: str, model_type: str, model_path: str):
        if camera_type == 'usb':
